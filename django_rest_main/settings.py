...
SECRET_KEY = 'django-insecure-smsw8x7dr=%oep+#o+^y!cn(omj_-&s#_)7m!tux3x9)pa6fog'
...
REST_FRAMEWORK={
    'DEFAULT_PAGINATION_CLASS':'rest_framework.pagination.LimitOffsetPagination',# LimitOffsetPagination or PageNumberPagination
    'PAGE_SIZE':2,
